...
public class JiraController {
    ...
    public String createIssue(JIRAIssue issue, String filename) {
        ...
        IssueInputBuilder newIssueBuilder = new IssueInputBuilder(issue.getProjKey(), issueTypeID,
                "Contact " + issue.getID());
        ...
        newIssueBuilder.setFieldValue(CUSTOMFIELDS.get("Antenna"),
                ComplexIssueInputFieldValue.with("value", issue.getFirstClass().getAntenna()));
        ...
        addFilenameProperty(issueKey, filename);
    ...
    public void archiveIssue(String issueKey) {
        try {
            URL url = new URL("http://vmoc-proj1.nrl.navy.mil:8080/rest/api/2/issue/" + issueKey + "/archive");
            HttpURLConnection httpConn = (HttpURLConnection) url.openConnection();
            httpConn.setRequestMethod("PUT");
